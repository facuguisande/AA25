...
# Este fue el primer procesamiento que hice de la humedad
# arme un prompt gigante y se lo pase una IA, para que me explique que hacer en cada paso
# en base a esto me sirvio para procesar los datos de lluvia y temperatura
# Aca se trabaja sobre un archivo llamado Dato, que lo tengo en la carpeta "archivos"


# Cargar el archivo Excel - específicamente la hoja "HR" (hoja 2)
try:
...
# Renombrar columnas para trabajar más fácilmente
...
#  Si hay múltiples entradas para la misma fecha, tomar la media y redondear
...
# Mostrar estadísticas sobre los días húmedos
